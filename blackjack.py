...
while not bankrupt:
    ...
    #betting phase (bankrupt check, take in bet, set current bet, withdraw bet from players banks)
    ...
    # Player 1 turn
    #loop for asking to hit or stand breaks on bust
    while not bust_check(player1):
        display_table(player1,computer,current_bet)
